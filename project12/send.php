<?php
    ...
    function sendEmail($recipient,$code){
        ...
        try{
            ...
            $mail->setFrom('minhquanpro2001@gmail.com', 'Văn phòng Khoa CNTT');
            // Tên hiển thị: TÊN CÁC BẠN, ví dụ: Nguyễn Sơn Lâm

            $mail->addReplyTo('minhquanpro2001@gmail.com', 'Văn phòng Khoa CNTT');

            $mail->addAddress($recipient); // Đây là địa chỉ Email người nhận > sau này sẽ là BIẾN
            // Gửi tới: minhquanpro2001@gmail.com
            // Tiêu đề Email là gì?
